...
import 'package:exampleddd/domain/auth/user.dart';
...
class FirebaseAuthFacade implements IAuthFacade {
  ...
  @override
  Future<Option<Userr>> getSignInUser() async {
    if(_firebaseAuth.currentUser != null) {
      return optionOf(Userr(id: UniqueId.formUniqueString(_firebaseAuth.currentUser!.uid)));
    }
    return none();
    //return optionOf(Userr(id: UniqueId.formUniqueString(_firebaseAuth.currentUser?.uid ?? '')));
  }
